# Moodle: Timed assignments and exams
...
Under this setting, students will be able to see the assignment and the description as soon as it is made available, but they will only be able to submit files from 2pm on April 1, 2020. Any submissions that occur after the due date will be marked as late. If you want to prevent late submissions, you can enable the cut-off option. If desired, you can also make the description of the assignment invisible to students until the start of the submission period by unchecking "Always show description."

The due dates/cutoffs that you set here are for the entire class. If you have to configure extra time for certain students, after you have saved the assignment you can use [user overrides](#overrides) as described in the section below.
...
That is because the Scale column contains all 22 points in the UofG scale. You should generally not mess with the spreadsheet, but you can safely delete that column to make it more readable.
